...
export const getGetTripsIdResponseMock = (overrideResponse: Partial< GetTripsId200 > = {}): GetTripsId200 => ({trip: {accommodationIds: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.number.int({min: undefined, max: undefined}))), destination: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), endDate: faker.string.alpha(20), id: faker.number.int({min: undefined, max: undefined}), image: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), startDate: faker.string.alpha(20), title: faker.string.alpha(20), todoIds: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => (faker.number.int({min: undefined, max: undefined}))), tripDays: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({dayDate: faker.string.alpha(20), dayDescription: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), dayOrder: faker.number.int({min: undefined, max: undefined}), tripRoutePoints: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({address: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), arrivalTime: faker.string.alpha(20), departureTime: faker.string.alpha(20), latLng: faker.helpers.arrayElement([{x: faker.number.int({min: undefined, max: undefined}), y: faker.number.int({min: undefined, max: undefined})}, undefined]), name: faker.string.alpha(20), visitOrder: faker.number.int({min: undefined, max: undefined})}))}))}, ...overrideResponse})
