...
export const getGetAccommodationsIdResponseMock = (overrideResponse: Partial< GetAccommodationsId200 > = {}): GetAccommodationsId200 => ({accommodation: {address: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), bookingUrl: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), checkIn: faker.string.alpha(20), checkOut: faker.string.alpha(20), id: faker.number.int({min: undefined, max: undefined}), image: faker.string.alpha(20), name: faker.string.alpha(20), notes: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), phoneNumber: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), reservationPrice: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), tripAdvisorUrl: faker.helpers.arrayElement([faker.string.alpha(20), undefined]), tripId: faker.number.int({min: undefined, max: undefined})}, ...overrideResponse})
