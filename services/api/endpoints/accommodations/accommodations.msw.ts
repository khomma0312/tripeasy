...
export const getGetAccommodationsSearchResponseMock = (overrideResponse: Partial< GetAccommodationsSearch200 > = {}): GetAccommodationsSearch200 => ({accommodations: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({address: faker.string.alpha(20), id: faker.number.int({min: undefined, max: undefined}), image: faker.string.alpha(20), informationUrl: faker.string.alpha(20), name: faker.string.alpha(20), reviewAverage: faker.number.int({min: undefined, max: undefined}), reviewCount: faker.number.int({min: undefined, max: undefined})})), ...overrideResponse})
