...
export const getPostRegisterResponseMock = (overrideResponse: Partial< PostRegister200 > = {}): PostRegister200 => ({user: {id: faker.number.int({min: undefined, max: undefined}), name: faker.string.alpha(20)}, ...overrideResponse})
